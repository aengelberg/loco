...
(def ^:dynamic *monitors*
  "(internal) Bound to a list of Choco monitor objects to be plugged
  into a Choco solver."
  [])
...
(defn current-solution
  "This is a stateful function to be used *during* interop with
  Choco. Can be used by Loco search monitors or Loco
  internals. Returns the current value of a variable during a solve,
  or a complete solution map if no specific variable name is
  provided."
  ([var-name]
   (-> @(:my-vars *solver*)
       (get var-name)
